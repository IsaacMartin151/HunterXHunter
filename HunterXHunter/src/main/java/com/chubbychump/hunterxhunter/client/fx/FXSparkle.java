...
public class FXSparkle extends SpriteTexturedParticle {
    ...
    private void wiggleAround(double x, double y, double z) {
        ...
        for (Direction direction1 : new Direction[] { Direction.NORTH, Direction.SOUTH, Direction.WEST, Direction.EAST, Direction.UP }) {
            blockpos$mutable.setPos(blockpos.getX(), blockpos.getY(), blockpos.getZ());
            blockpos$mutable.move(direction1);
            if (!this.world.getBlockState(blockpos$mutable).isOpaqueCube(this.world, blockpos$mutable)) {
