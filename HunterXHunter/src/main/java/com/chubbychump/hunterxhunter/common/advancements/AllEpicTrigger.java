...
public class AllEpicTrigger extends AbstractCriterionTrigger<AllEpicTrigger.Instance> {
    public static final ResourceLocation ID = new ResourceLocation(MOD_ID, "all_epic");
    public static final AllEpicTrigger INSTANCE = new AllEpicTrigger();

    private AllEpicTrigger() {}
