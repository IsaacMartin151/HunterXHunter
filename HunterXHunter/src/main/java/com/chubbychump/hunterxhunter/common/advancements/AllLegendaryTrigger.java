...
public class AllLegendaryTrigger extends AbstractCriterionTrigger<AllLegendaryTrigger.Instance> {
    public static final ResourceLocation ID = new ResourceLocation(MOD_ID, "all_legendary");
    public static final AllLegendaryTrigger INSTANCE = new AllLegendaryTrigger();

    private AllLegendaryTrigger() {}
