...
import static com.chubbychump.hunterxhunter.util.RegistryHandler.AURA_STONE;

public class WorldTreeFeature2 extends Feature<WorldTreeConfig2> {
    public WorldTreeFeature2() {
