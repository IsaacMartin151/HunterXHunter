package com.chubbychump.hunterxhunter.common.generation.structures;
...
import static com.chubbychump.hunterxhunter.util.RegistryHandler.WORLD_TREE_STRUCTURE;

public class HXHConfiguredStructures {
    /**
     * Static instance of our structure so we can reference it and add it to biomes easily.
     */
    public static StructureFeature<?, ?> CONFIGURED_WORLD_TREE = WORLD_TREE_STRUCTURE.get().withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG);
