...
public class GiantLizardModel<T extends GiantLizard> extends EntityModel<GiantLizard> {
    ...
    @Override
    public void setRotationAngles(GiantLizard entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
