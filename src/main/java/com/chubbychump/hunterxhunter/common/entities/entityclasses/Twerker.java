...
import com.chubbychump.hunterxhunter.common.entities.controllers.CameraLookController;
...
public class Twerker extends CreatureEntity {
    private static final DataParameter<Float> COUNTER = EntityDataManager.createKey(Twerker.class, DataSerializers.FLOAT);
    private static final DataParameter<Float> TARGET_POS_X = EntityDataManager.createKey(Twerker.class, DataSerializers.FLOAT);
    private static final DataParameter<Float> TARGET_POS_Y = EntityDataManager.createKey(Twerker.class, DataSerializers.FLOAT);
    private static final DataParameter<Float> TARGET_POS_Z = EntityDataManager.createKey(Twerker.class, DataSerializers.FLOAT);
    public int amp = 5;
    ...
    public Twerker(EntityType<? extends CreatureEntity> entityTypeIn, World worldIn) {
    ...
    public Twerker(EntityType<? extends CreatureEntity> entityTypeIn, World worldIn, PlayerEntity player, ItemStack istack) {
