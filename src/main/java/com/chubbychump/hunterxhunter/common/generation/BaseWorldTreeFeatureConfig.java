...
public class BaseWorldTreeFeatureConfig implements IFeatureConfig {
    public static final Codec<BaseWorldTreeFeatureConfig> CODEC = RecordCodecBuilder.create((builder) -> {
        ...
        })).apply(builder, BaseWorldTreeFeatureConfig::new);
    });
    ...
    protected BaseWorldTreeFeatureConfig(BlockStateProvider trunkProvider, BlockStateProvider leavesProvider, FoliagePlacer foliagePlacer, AbstractTrunkPlacer trunkPlacer, AbstractFeatureSizeType minimumSize, List<TreeDecorator> decorators, int maxWaterDepth, boolean ignoreVines, Heightmap.Type p_i232020_9_) {
    ...
    public BaseWorldTreeFeatureConfig func_236685_a_(List<TreeDecorator> decorators) {
        return new BaseWorldTreeFeatureConfig(this.trunkProvider, this.leavesProvider, this.foliagePlacer, this.trunkPlacer, this.minimumSize, decorators, this.maxWaterDepth, this.ignoreVines, this.field_236682_l_);
    }
    ...
    public static class Builder {
        ...
        public BaseWorldTreeFeatureConfig.Builder setDecorators(List<TreeDecorator> decorators) {
            this.decorators = decorators;
            return this;
        }

        public BaseWorldTreeFeatureConfig.Builder setMaxWaterDepth(int p_236701_1_) {
            this.maxWaterDepth = p_236701_1_;
            return this;
        }

        public BaseWorldTreeFeatureConfig.Builder setIgnoreVines() {
            this.ignoreVines = true;
            return this;
        }

        public BaseWorldTreeFeatureConfig.Builder func_236702_a_(Heightmap.Type p_236702_1_) {
            this.field_236699_i_ = p_236702_1_;
            return this;
        }

        public BaseWorldTreeFeatureConfig build() {
            return new BaseWorldTreeFeatureConfig(this.trunkProvider, this.leavesProvider, this.foliagePlacer, this.trunkPlacer, this.minimumSize, this.decorators, this.maxWaterDepth, this.ignoreVines, this.field_236699_i_);
        }
    }
}
