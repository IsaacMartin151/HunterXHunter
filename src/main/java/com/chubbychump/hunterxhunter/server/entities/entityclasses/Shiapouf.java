...
public class Shiapouf extends MonsterEntity implements IChargeableMob, IRangedAttackMob {
    private static final DataParameter<Integer> FIRST_HEAD_TARGET = EntityDataManager.createKey(Shiapouf.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> SECOND_HEAD_TARGET = EntityDataManager.createKey(Shiapouf.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> THIRD_HEAD_TARGET = EntityDataManager.createKey(Shiapouf.class, DataSerializers.VARINT);
    ...
    private static final DataParameter<Integer> INVULNERABILITY_TIME = EntityDataManager.createKey(Shiapouf.class, DataSerializers.VARINT);
    ...
    private ServerBossInfo bossInfo = (ServerBossInfo)(new ServerBossInfo(this.getDisplayName(), BossInfo.Color.GREEN, BossInfo.Overlay.PROGRESS)).setDarkenSky(true);
    ...
    public Shiapouf(EntityType<? extends Shiapouf> wither, World world) {
        super(wither, world);
        this.setHealth(this.getMaxHealth());
        this.getNavigator().setCanSwim(true);
        this.experienceValue = 50;
        //this.setCustomName(ITextComponent.getTextComponentOrEmpty("Shiapouf"));
    }

    protected void registerGoals() {
        this.goalSelector.addGoal(0, new Shiapouf.DoNothingGoal());
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        if (this.isInvulnerableTo(source)) {
            return false;
        } else if (source != DamageSource.DROWN && !(source.getTrueSource() instanceof Shiapouf)) {
    ...
    public boolean isCharged() {
        ...
        if (this.getHealth() <= yeet) {
            this.lastexplosion -= 50.0F;
        }
    ...
    class DoNothingGoal extends Goal {
        ...
        public boolean shouldExecute() {
            return Shiapouf.this.getInvulTime() > 0;
