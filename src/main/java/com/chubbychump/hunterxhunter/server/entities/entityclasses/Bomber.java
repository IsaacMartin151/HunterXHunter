...
public class Bomber extends Creeper implements PowerableMob {
    private static final EntityDataAccessor<Integer> DATA_SWELL_DIR = SynchedEntityData.defineId(Bomber.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Boolean> DATA_IS_POWERED = SynchedEntityData.defineId(Bomber.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Boolean> DATA_IS_IGNITED = SynchedEntityData.defineId(Bomber.class, EntityDataSerializers.BOOLEAN);
    ...
    public Bomber(EntityType<? extends Creeper> p_32278_, Level p_32279_) {
