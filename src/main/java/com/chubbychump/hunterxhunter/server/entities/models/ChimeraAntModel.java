...
public class ChimeraAntModel<T extends Entity> extends EntityModel<T> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation CHIMERA_ANT_TEXTURE = new ModelLayerLocation(new ResourceLocation(HunterXHunter.MOD_ID, "chimera_ant"), "main");
    private final ModelPart head;
    private final ModelPart body;
    private final ModelPart legs;

    public ChimeraAntModel(ModelPart root) {
