...
public class Neferpitou extends MonsterEntity implements IChargeableMob, IRangedAttackMob {
    //private static final DataParameter<Integer> FIRST_HEAD_TARGET = EntityDataManager.createKey(Neferpitou.class, DataSerializers.VARINT);
    //private static final DataParameter<Integer> SECOND_HEAD_TARGET = EntityDataManager.createKey(Neferpitou.class, DataSerializers.VARINT);
    //private static final DataParameter<Integer> THIRD_HEAD_TARGET = EntityDataManager.createKey(Neferpitou.class, DataSerializers.VARINT);
    ...
    //private static final DataParameter<Integer> INVULNERABILITY_TIME = EntityDataManager.createKey(Neferpitou.class, DataSerializers.VARINT);
    ...
    private ServerBossInfo bossInfo = (ServerBossInfo)(new ServerBossInfo(this.getDisplayName(), BossInfo.Color.PINK, BossInfo.Overlay.PROGRESS)).setDarkenSky(true);
    ...
    public Neferpitou(EntityType<? extends Neferpitou> wither, World world) {
        super(wither, world);
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(0, new Neferpitou.DoNothingGoal());
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        if (this.isInvulnerableTo(source)) {
            return false;
        } else if (source != DamageSource.DROWN && !(source.getTrueSource() instanceof Neferpitou)) {
    ...
    class DoNothingGoal extends Goal {
        ...
        public boolean shouldExecute() {
            //return Neferpitou.this.getInvulTime() > 0;
