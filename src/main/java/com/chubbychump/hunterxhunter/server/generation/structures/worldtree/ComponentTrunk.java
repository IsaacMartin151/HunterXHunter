...
import static com.chubbychump.hunterxhunter.util.RegistryHandler.WTTRUNK;

public class ComponentTrunk extends WorldTreeBaseComponent {
    private int height;
    private int width;
    ...
    public ComponentTrunk(TemplateManager manager, CompoundNBT nbt) {
        super(WTTRUNK, nbt);
    }

    public ComponentTrunk(Feature feature, Random rand, int i, int x, int y, int z, int width, int height, Direction direction) {
        super(WTTRUNK, feature, i);
        this.setCoordBaseMode(direction);
        this.boundingBox = WorldTreeBaseComponent.getComponentToAddBoundingBox2(x, y, z, 0, -height / 2, -width / 2, 1, height - 1, width - 1, direction);
    }
    ...
    public boolean func_230383_a_(ISeedReader world, StructureManager manager, ChunkGenerator generator, Random rand, MutableBoundingBox sbb, ChunkPos chunkPosIn, BlockPos blockPos) {
        ...
        final BlockState castleMagic = Blocks.OAK_LOG.getDefaultState();
