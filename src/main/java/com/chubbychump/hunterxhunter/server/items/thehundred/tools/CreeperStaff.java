...
public class CreeperStaff extends StaffBase {
    public CreeperStaff() {
        super();
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level worldIn, Player playerIn, InteractionHand handIn) {
        ...
        if (!worldIn.isClientSide) {
            ...
            Bat bruh = new Bat(EntityType.BAT, worldIn);
            bruh.setPos(playerIn.getX(), playerIn.getY(), playerIn.getZ());
            playerIn.level.addFreshEntity(bruh);
